 ...
 * </p>
 * <ul>
 *   <li>{@link com.github.nruzic.commons.model.profile.general.impl.externalImpl#getBase_Actor <em>Base Actor</em>}</li>
 *   <li>{@link com.github.nruzic.commons.model.profile.general.impl.externalImpl#getBase_Class <em>Base Class</em>}</li>
 *   <li>{@link com.github.nruzic.commons.model.profile.general.impl.externalImpl#getBase_Component <em>Base Component</em>}</li>
 *   <li>{@link com.github.nruzic.commons.model.profile.general.impl.externalImpl#getBase_ExecutionEnvironment <em>Base Execution Environment</em>}</li>
 *   <li>{@link com.github.nruzic.commons.model.profile.general.impl.externalImpl#getBase_Model <em>Base Model</em>}</li>
 *   <li>{@link com.github.nruzic.commons.model.profile.general.impl.externalImpl#getBase_Node <em>Base Node</em>}</li>
 *   <li>{@link com.github.nruzic.commons.model.profile.general.impl.externalImpl#getBase_Package <em>Base Package</em>}</li>
 * </ul>
 *
 * @generated
 */
public class externalImpl extends MinimalEObjectImpl.Container implements external {
	...
	protected EClass eStaticClass() {
		return GeneralPackage.Literals.EXTERNAL;
	}
		...
		if (base_Actor != null && base_Actor.eIsProxy()) {
			...
			if (base_Actor != oldBase_Actor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GeneralPackage.EXTERNAL__BASE_ACTOR, oldBase_Actor, base_Actor));
			}
		}
		return base_Actor;
	}
	...
	public void setBase_Actor(Actor newBase_Actor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneralPackage.EXTERNAL__BASE_ACTOR, oldBase_Actor, base_Actor));
	}
	...
	public org.eclipse.uml2.uml.Class getBase_Class() {
		if (base_Class != null && base_Class.eIsProxy()) {
			...
			if (base_Class != oldBase_Class) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GeneralPackage.EXTERNAL__BASE_CLASS, oldBase_Class, base_Class));
			}
		}
		return base_Class;
	}
	...
	public void setBase_Class(org.eclipse.uml2.uml.Class newBase_Class) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneralPackage.EXTERNAL__BASE_CLASS, oldBase_Class, base_Class));
	}
	...
	public Component getBase_Component() {
		if (base_Component != null && base_Component.eIsProxy()) {
			...
			if (base_Component != oldBase_Component) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GeneralPackage.EXTERNAL__BASE_COMPONENT, oldBase_Component, base_Component));
			}
		}
	...
	public void setBase_Component(Component newBase_Component) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneralPackage.EXTERNAL__BASE_COMPONENT, oldBase_Component, base_Component));
	}
	...
	public ExecutionEnvironment getBase_ExecutionEnvironment() {
		if (base_ExecutionEnvironment != null && base_ExecutionEnvironment.eIsProxy()) {
			...
			if (base_ExecutionEnvironment != oldBase_ExecutionEnvironment) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GeneralPackage.EXTERNAL__BASE_EXECUTION_ENVIRONMENT, oldBase_ExecutionEnvironment, base_ExecutionEnvironment));
			}
		}
	...
	public void setBase_ExecutionEnvironment(ExecutionEnvironment newBase_ExecutionEnvironment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneralPackage.EXTERNAL__BASE_EXECUTION_ENVIRONMENT, oldBase_ExecutionEnvironment, base_ExecutionEnvironment));
	}
	...
	public Model getBase_Model() {
		if (base_Model != null && base_Model.eIsProxy()) {
			...
			if (base_Model != oldBase_Model) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GeneralPackage.EXTERNAL__BASE_MODEL, oldBase_Model, base_Model));
			}
		}
		return base_Model;
	}
	...
	public void setBase_Model(Model newBase_Model) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneralPackage.EXTERNAL__BASE_MODEL, oldBase_Model, base_Model));
	}
	...
	public Node getBase_Node() {
		if (base_Node != null && base_Node.eIsProxy()) {
			...
			if (base_Node != oldBase_Node) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GeneralPackage.EXTERNAL__BASE_NODE, oldBase_Node, base_Node));
			}
		}
		return base_Node;
	}
	...
	public void setBase_Node(Node newBase_Node) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneralPackage.EXTERNAL__BASE_NODE, oldBase_Node, base_Node));
	}
	...
	public org.eclipse.uml2.uml.Package getBase_Package() {
		if (base_Package != null && base_Package.eIsProxy()) {
			...
			if (base_Package != oldBase_Package) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GeneralPackage.EXTERNAL__BASE_PACKAGE, oldBase_Package, base_Package));
			}
		}
		return base_Package;
	}
	...
	public void setBase_Package(org.eclipse.uml2.uml.Package newBase_Package) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneralPackage.EXTERNAL__BASE_PACKAGE, oldBase_Package, base_Package));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GeneralPackage.EXTERNAL__BASE_ACTOR:
				if (resolve) return getBase_Actor();
				return basicGetBase_Actor();
			case GeneralPackage.EXTERNAL__BASE_CLASS:
				if (resolve) return getBase_Class();
				return basicGetBase_Class();
			case GeneralPackage.EXTERNAL__BASE_COMPONENT:
				if (resolve) return getBase_Component();
				return basicGetBase_Component();
			case GeneralPackage.EXTERNAL__BASE_EXECUTION_ENVIRONMENT:
				if (resolve) return getBase_ExecutionEnvironment();
				return basicGetBase_ExecutionEnvironment();
			case GeneralPackage.EXTERNAL__BASE_MODEL:
				if (resolve) return getBase_Model();
				return basicGetBase_Model();
			case GeneralPackage.EXTERNAL__BASE_NODE:
				if (resolve) return getBase_Node();
				return basicGetBase_Node();
			case GeneralPackage.EXTERNAL__BASE_PACKAGE:
