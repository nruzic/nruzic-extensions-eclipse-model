...
public class ApplicationsFactoryImpl extends EFactoryImpl implements ApplicationsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ApplicationsPackage.THICKCLIENTAPPLICATION: return createthickclientapplication();
			case ApplicationsPackage.THINCLIENTAPPLICATION: return createthinclientapplication();
			default:
	 ...
	 * @generated
	 */
	public thickclientapplication createthickclientapplication() {
		thickclientapplicationImpl thickclientapplication = new thickclientapplicationImpl();
		return thickclientapplication;
	}
	 ...
	 * @generated
	 */
	public thinclientapplication createthinclientapplication() {
		thinclientapplicationImpl thinclientapplication = new thinclientapplicationImpl();
		return thinclientapplication;
	}
